...
def run_tpot_automl(
    ...
    export_checkpoints_dir = DATA_DIR / "results" / "autoML" / "tpot" / run_id / "checkpoints"
    ...
    search = TPOTRegressor(
        ...
        periodic_checkpoint_folder = str(export_checkpoints_dir),
    ...
    result = {
        "search_history": search.evaluated_individuals,
        "best_model": {
